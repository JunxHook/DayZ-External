...
namespace ImGui
{
    ...
    IMGUI_API bool          InputText2(const char* label, std::string buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
